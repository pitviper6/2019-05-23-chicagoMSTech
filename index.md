...
venue: "Microsoft Technology Center"        # brief name of host site without address (e.g., "Euphoric State University")
address: "200 E. Randolph St., Suite 200, Chicago, IL 60601"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "US"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "EN"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "41.885303,-87.621521"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Karen Gutzman", "Adam Hecktman", "Avishek Kumar", "Will Trimble"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Juliane Schneider"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2019-05-23-chicagoMSTech     # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite:  "59466399602"        # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<p>
  <strong>NOTE:</strong> There will <strong>not</strong> be catering provided, but there are a wide variety of coffee and lunch options available close to the venue.
</p>
